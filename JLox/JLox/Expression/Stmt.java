...
public abstract class Stmt {
  ...
  public static class Class extends Stmt {
    public Class(Token name, Expr.Variable superclass, List<Stmt.Function> staticMethods, List<Stmt.Function> methods, List<Stmt.Function> getter) {
      this.name = name;
    ...
    public final List<Stmt.Function> getter;
  }
